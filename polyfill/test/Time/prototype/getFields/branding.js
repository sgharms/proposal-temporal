...
assert.throws(TypeError, () => getFields.call(Temporal.Time), "Temporal.Time");
assert.throws(TypeError, () => getFields.call(Temporal.Time.prototype), "Temporal.Time.prototype");
