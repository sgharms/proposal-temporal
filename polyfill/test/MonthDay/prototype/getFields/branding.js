...
assert.throws(TypeError, () => getFields.call(Temporal.MonthDay), "Temporal.MonthDay");
assert.throws(TypeError, () => getFields.call(Temporal.MonthDay.prototype), "Temporal.MonthDay.prototype");
