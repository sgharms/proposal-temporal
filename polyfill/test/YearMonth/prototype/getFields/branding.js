...
assert.throws(TypeError, () => getFields.call(Temporal.YearMonth), "Temporal.YearMonth");
assert.throws(TypeError, () => getFields.call(Temporal.YearMonth.prototype), "Temporal.YearMonth.prototype");
